...
- Dark Blue (footer background): hsl(216, 53%, 9%)           	#0b1523 - in footer
- Dark Blue (testimonials background): hsl(219, 30%, 18%)     	#202a3c - in three blocks at bottom
...
.attribution a { color: hsl(228, 45%, 44%); }- 	#3e52a3
